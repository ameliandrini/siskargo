        ...
        <div class="right_col" role="main">
		  ...
		  <!--list userakses-->
			...
			<div class="col-md-12 col-sm-4 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                <h2>List Barang Kiriman</h2>
                  <div class="clearfix"></div>
                </div>
                <div class="x_content" style="height:100%">
				  <input type="hidden" id="userid" value="">
				  	@if (auth()->user()->level == '1')
					  <a href="/siskargo/addbarangkiriman" class="btn btn-success" title="Tambah Barang Kiriman" data-target=".bs-example-modal-smadd" style="float:right;display:block;" 
                  id="tomboltambah"><i class="fa fa-plus"></i> Tambah Barang Kiriman</a></br>
					@else
					&nbsp;</br>
					@endif
                  ...
                  <table id="mydata" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
                      ...
                      <tr style="background-color:#F7F7F7;color:#000000;">
                          ...
                          <td>
							...
							@if (auth()->user()->level == '1')
							<a href="/siskargo/detailbarangkiriman/{{$pengiriman->pengiriman_id}}" class="btn btn-primary">Detail</a>
							<a href="/siskargo/invoicepengiriman/{{$pengiriman->pengiriman_id}}" class="btn btn-danger">Cetak Tanda Terima</a>
							<!-- <a href="/siskargo/suratjalan/{{$pengiriman->pengiriman_id}}" class="btn btn-warning">Cetak Surat Jalan</a> -->
