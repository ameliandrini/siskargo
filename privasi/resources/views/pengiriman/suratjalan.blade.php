        ...
        <table>
            ...
            <tr>
               ...
               <tr>
                ...
                <tr>
                    <td>No. Polisi:</td>
                    <td>{{ $invoice->pengirimanh_nopol }}</td>
                    <td>Hari:</td>
                    <td>{{ $invoice->pengirimanh_harijln }}</td>
                </tr>
                <tr>
                    <td>Nama Supir:</td>
                    <td>{{ $invoice->name }}</td>
                    <td>Tanggal:</td>
                    <td>{{ $invoice->pengirimanh_tgljln }}</td>
                </tr>
                <tr>
                    <td>Dari:</td>
                    <td><b>Jakarta</b></td>
                ...
                <tr>
                    ...
                    <td>Trip:</td>
                    <td>{{ $invoice->pengirimanh_trip }}</td>
                </tr>
            <!-- </thead>
            <tbody> -->
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="2" style="border: 1px solid black;">{{ $invoice->jenis_nama }}</td>
                    
                </tr>
                <tr>
                    <td colspan="2" style="border: 1px solid black;">Upah Mobil:</td>
                    <td colspan="2" style="border: 1px solid black;">{{ number_format($invoice->pengirimanh_upahmobil,0,",",".") }}</td>
                </tr>
                <tr>
                    <td colspan="2" style="border: 1px solid black;">Uang Jalan Dari Jakarta:</td>
                    <td colspan="2" style="border: 1px solid black;">{{ number_format($invoice->pengirimanh_uangjalanjkt,0,",",".")  }}</td>
                </tr>
                <tr>
                    <td colspan="2" style="border: 1px solid black;">Uang Sisa Bayar Bukittinggi:</td>
                    <td colspan="2" style="border: 1px solid black;">{{ number_format($invoice->pengirimanh_uangsisabkt,0,",",".")  }}</td>
                </tr>
                <tr>
                    <td colspan="2" style="border: 1px solid black;">No. Rekap Barang:</td>
                    <td colspan="2" style="border: 1px solid black;">{{ $invoice->pengirimanh_id }}</td>
                </tr>
                <tr>
                    <td colspan="2" style="border: 1px solid black;">Keterangan:</td>
                    <td style="border: 1px solid black;">{{ $invoice->pengirimanh_ket }}</td>
                    <td style="border: 1px solid black;text-align:right;">{{ $invoice->pengirimanh_berat }}Kg</td>
                </tr>
                <tr>
                    <td colspan="4">&nbsp;</td>
