		  ...
		  <!--list userakses-->
			...
			<div class="col-md-12 col-sm-4 col-xs-12">
              <div class="x_panel">
                ...
                <form id="form-reportpengiriman" action="/siskargo/pdfpengiriman" data-parsley-validate class="form-horizontal form-label-left" method="post" >
                    {{csrf_field()}}
					<div class="form-group">
						<label for="pengiriman_tgl" class="control-label col-md-3 col-sm-3 col-xs-12" >Tanggal </label>
						<div class="col-md-3 col-sm-3 col-xs-12">
						<div class="input-group date" id="myDatepicker2">
							<input type="text" class="form-control col-md-7 col-xs-12" id="pengiriman_tgl" name="pengiriman_tgl1" />
							<span class="input-group-addon">
								<span class="glyphicon glyphicon-calendar"></span>
							</span>
						</div>	
						</div>
						<label for="pengiriman_tgl2" class="control-label col-md-1 col-sm-1 col-xs-12" >Sampai </label>
						<div class="col-md-3 col-sm-3 col-xs-12">
						<div class="input-group date" id="myDatepicker3">
							<input type="text" class="form-control col-md-7 col-xs-12" id="pengiriman_tgl2" name="pengiriman_tgl2" />
							<span class="input-group-addon">
								<span class="glyphicon glyphicon-calendar"></span>
							</span>
						</div>	
