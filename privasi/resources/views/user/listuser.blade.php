			...
			<div class="col-md-12 col-sm-4 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content" style="height:100%">
                  ...
                  <a href="/siskargo/adduser" class="btn btn-success" title="Tambah User" data-target=".bs-example-modal-smadd" style="float:right;display:block;" 
                  ...
                  <table id="mydata" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
                      ...
                      <tr style="background-color:#F7F7F7;color:#000000;">
                          ...
                          <td>{{$user->email}}</td>
                          <td>
                            <a href="/siskargo/edituser/{{$user->id}}" class="btn btn-primary">Edit
                            <a href="/siskargo/deleteuser/{{$user->id}}" class="btn btn-danger item_deleteuser" data-id="{{$user->id}}">Delete</td>
                        </tr>
                      @endforeach
                      </tbody>
                    </table>
